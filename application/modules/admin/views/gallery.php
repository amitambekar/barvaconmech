<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        <li class="active"><a href="javascript:;">Gallery master</a></li>
    </ol>
</div>
...
<div class="container-fluid-md">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title">Gallery master</h4>
            ...
            <div class="panel-body">
                ...
                <form id="myForm" method="POST" action="<?php echo site_url(); ?>/admin/products/add" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="exampleInputText1">Caption</label>
                        <div class="controls">
                            <textarea id="wysiwyg" name="caption" class="form-control" placeholder="Enter message ..." rows="10"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="exampleInputText1">Upload Images</label>
                        <div class="controls">
...
<div class="container-fluid-md">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title">List Of Gallery</h4>
