                ...
                <nav>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="nav-dropdown">
                            ...
                            <ul class="nav-sub">
                                <li>
                                    <a href="<?= site_url(); ?>/admin/pscm" title="Product & Services Category Master">
                                        <i class="fa fa-fw fa-caret-right"></i> Product & Services Category Master
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= site_url(); ?>/admin/products" title="Product & Services Master">
                                        <i class="fa fa-fw fa-caret-right"></i> Product & Services Master
                                    </a>
                                </li>
                            </ul>
                        </li>
